        ...
        <div class="row">
            ...
            <div class="col-10" style="padding-left: 0; padding-right: 0;">
                ...
                <div class="nav shadow-sm">
                    <h2 class="py-4 fw-bolder mx-auto text-center" style="font-family: 'Noto Serif', serif;">Attendance Record</h2>
                            ...
                            <tbody>
                                ...
                                <?php
                                    if (isset($_POST['Search'])) 
                                    {
                                        ...
                                        $srchQuery = "SELECT * FROM attendance WHERE stud_name = '{$search}'";
                                ...
                                ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row1['attendance'] ?></td>
                                                    <td>
                                                        <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                                                            <a class="btn btn-danger view_btn" href="#"><i class="fa fa-eye"></i></a>
                                                        </form>
