...
<head>
    ...
    <link rel="stylesheet" href="Comments.css ?v=<?php echo time(); ?>">

    <title>Admin | Comments Record</title>
        ...
        <div class="row">
            ...
            <div class="col-10" style="padding-left: 0; padding-right: 0;">
                ...
                <div class="nav shadow-sm">
                    <h2 class="py-4 fw-bolder mx-auto text-center" style="font-family: 'Noto Serif', serif;">Comments Record</h2>
                        ...
                        <table id="dataTableId" class="table table-striped table-hover my-3 px-5">
                            ...
                            <tbody>
                                ...
                                <?php
                                    ...
                                    {
                                        $search = $_POST['SrchId'];
                                        $srchQuery = "SELECT * FROM comments WHERE c_id = '{$search}'";
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <?php echo $row1['c_email'] ?>
                                    </td>
                                    <td>
                                        <?php echo $row1['c_message'] ?>
                                    </td>
                                    <td>
                                        <input type="hidden" class="delete_id_value" value="<?php echo $ID; ?>">
                                        <a href="javascript:void(0)" class="delete_btn_ajax btn btn-danger deleteBtn">Delete</a>
