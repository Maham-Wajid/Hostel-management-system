        ...
        <div class="row">
            ...
            <div class="col-10" style="padding-left: 0; padding-right: 0;">
                <div class="nav shadow-sm">
                    <h2 class="py-4 fw-bolder mx-auto text-center" style="font-family: 'Noto Serif', serif;">Attendant Profile</h2>
                    ...
                    <div class="col-md-4 col-12">
                        <div class="my-5 ms-5">
                            <div class="card" style="width: 18rem;">
                                ...
                                <div class="card-body">
                                    <?php 
                                        $query1 = "SELECT * FROM attendant WHERE attendant_id = '$id'";
                                    ...
                                    <div style="text-align:center"><img src="<?php echo "../Admin/" .$query1row['attendant_picture']; ?>" alt="Image" width="100px"></div>
                                </div>
                        ...
                        <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                            <div class="row my-5 ms-3 me-5">
                                <div class="col-12">
                                    ...
                                    <input class="form-control" type="text" name="Name" value="<?php echo $query1row['attendant_name']; ?>" readonly>
                                </div>
                                <div class="col-12">
                                    <label for="Gender" class="form-label fw-bold">Gender: </label>
                                    <input class="form-control" type="text" name="Gender" value="<?php echo $query1row['attendant_gender']; ?>" readonly>
                                </div>
                                <div class="col-12">
                                    <label for="Contact" class="form-label fw-bold">Contact: </label>
                                    <input class="form-control" type="text" name="Contact" value="<?php echo $query1row['attendant_contact']; ?>" readonly>
                                </div>
                                <div class="col-12">
                                    <label for="DOB" class="form-label fw-bold">Date of Birth: </label>
                                    <input class="form-control" type="date" name="DOB" value="<?php echo $query1row['attendant_DOB']; ?>" readonly>
                                </div>
                                <div class="col-12">
                                    <label for="CNIC" class="form-label fw-bold">CNIC: </label>
                                    <input class="form-control" type="text" name="CNIC" value="<?php echo $query1row['attendant_CNIC']; ?>" readonly>
                                </div>
                                <div class="col-12">
                                    <label for="Email" class="form-label fw-bold">Email: </label>
                                    <input class="form-control" type="email" name="Email" value="<?php echo $query1row['attendant_email']; ?>" readonly>
                                </div>
                                <div class="col-12">
                                    <label for="Address" class="form-label fw-bold">Address: </label>
                                    <input class="form-control" type="text" name="Address" value="<?php echo $query1row['attendant_address']; ?>" readonly>
                                </div>
                                <div class="col-12">
                                    <label for="Address" class="form-label fw-bold">Permanent Address: </label>
                                    <input class="form-control" type="text" name="Address" value="<?php echo $query1row['attendant_pAddress']; ?>" readonly>
                                </div>
                            </div>
                        </form>
                    </div>
